...
#Initialize UpdateCursor to find the full adress and the parse to find the
#street direction and type (specified in the fields called in the cursor below).
with arcpy.da.UpdateCursor(Update_FC, ['Strt_Name','Strt_Type','Strt_Direc']) as cursor:
    ...
    for row in cursor:
        ...
        if row[0] != " " and row[0] != None:
            ...
            #Initialize a list of possible street types for the input parced value'strt_type'
            #to be checked against. If this value is contained in the list, the value is added.
            ...
            #Initialize a list of possible street directions for the input parced value
            #'strt_direction'to be checked against. If this value is contained in the list, the value is added.
